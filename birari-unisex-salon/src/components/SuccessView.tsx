      ...
      <div className="container-narrow pt-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            Thank you, <span className="font-medium text-white">{customer.name}</span>.
          </p>
        </div>
        ...
        <section className="mt-6">
          <OfferUnlock
            token={scratchCard.token}
            initialStatus={currentStatus}
            offerTitle={scratchCard.offerTitle}
            offerDescription={scratchCard.offerDescription}
            qrDataUrl={qrDataUrl}
